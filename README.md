...
<div align="center">
  <img src=["https://github.com/orelgrBGU/Diplomat_Visualization/blob/main/duration_plot1.png?raw=true"](https://github.com/orelgrBGU/Diplomat_Visualization/blob/main/viz%202.png?raw=true)
       alt="Visit Duration Visualization"
       width="80%"
       style="border: 1px solid #ccc; border-radius: 8px;">
</div>

...
<table dir="rtl">
  ...
  <tbody>
    <tr>
      <td><strong>What </strong></td>
      <td>
 הנתונים הם נתונים טבלאיים תפעוליים, שבהם כל רשומה מייצגת ביקור שבוצע בפועל על ידי סוכן. לכל ביקור משויכים מנהל הסוכן, סוג הביקור (פיזי או טלפוני), והאם הביקור היה מתוכנן מראש והאם בוצע בהתאם לתכנון. הנתונים מאוגדים לרמת מנהל סוכנים ומנורמלים כך שכל מנהל מיוצג ב־100% מסך הביקורים שבוצעו תחתיו.
      </td>
    </tr>
    <tr>
      <td><strong>Why </strong></td>

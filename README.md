...
| רכיב | תוכן |
|------|-------|
| **What – מה מוצג?** | תיאור הנתונים המשמשים בגרף: אילו משתנים נמדדים, אילו יחידות, איזה סוג טבלה או קלט קיים. לדוגמה: נתוני ביקורים בפועל, זמני ביקור, סכום הזמנות, ערים וסוכנים. |
| **Why – למה בחרנו בגרף הזה?** | המטרה האנליטית של הוויזואליזציה: מה אנו רוצים לגלות מהגרף? דפוסים, מגמות, חריגים, השוואות בין ערים, יחס מאמץ-מכירות וכו'. |
| **How – איך הגרף מציג את הנתונים?** | תיאור אופן הקידוד הגרפי: מה על ציר X, מה על ציר Y, הצבעים, צורות הנקודות, חלוקה לקטגוריות, Stack/Bar/Scatter, שימוש באינטרקטיביות וכדומה. |

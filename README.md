...
-
## עבודות עבר קשורות בחברה 
עד היום החברה לא הציגה את הנתונים האלו באופן גרפי, אלא השתמשה בטבלאות אקסל בלבד. משום כך, לא קיימות עבודות קודמות או גרפים ישנים שיכולים לשמש לנו כבסיס להשוואה. הפרויקט הנוכחי הוא הפעם הראשונה שבה המידע הזה עובר ויזואליזציה.
## ויזואליזציה 1 
